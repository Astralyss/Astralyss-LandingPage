...
export default function AdminLayout({ children }) {
  ...
  if (pathname === '/admin/login') {
    return (
      <>
        <Head>
          <title>Login Administrativo - Astralyss</title>
          <meta name="robots" content="noindex, nofollow" />
          <meta name="description" content="Acceso administrativo restringido" />
        </Head>
  ...
  return (
    <>
      <Head>
        <title>Panel Administrativo - Astralyss</title>
        <meta name="robots" content="noindex, nofollow" />
        <meta name="description" content="Panel administrativo restringido" />
      </Head>
